...
Public Class SourceVtaFile35

#Region "Creation and Destruction"

	Public Sub New(ByVal outputFileStream As StreamWriter, ByVal mdlFileData As SourceMdlFileData35)
...
#Region "Methods"
	...
	'	Dim aVtxStripGroup As SourceVtxStripGroup06
	...
	'	Try
	'		aVtxLod = aVtxModel.theVtxModelLods(0)
	...
	'						aVtxStripGroup = aVtxMesh.theVtxStripGroups(groupIndex)

	'						If aVtxStripGroup.theVtxStrips IsNot Nothing AndAlso aVtxStripGroup.theVtxIndexes IsNot Nothing AndAlso aVtxStripGroup.theVtxVertexes IsNot Nothing Then
	'							For aVtxIndexIndex As Integer = 0 To aVtxStripGroup.theVtxIndexes.Count - 3 Step 3
	'								Dim bodyModelIndex As Integer = Me.theMdlFileData.theBodyParts(bodyPartIndex).theModels.IndexOf(aModel)
	'								aVtxVertexIndex = aVtxStripGroup.theVtxIndexes(aVtxIndexIndex)
	'								aVtxVertex = aVtxStripGroup.theVtxVertexes(aVtxVertexIndex)
