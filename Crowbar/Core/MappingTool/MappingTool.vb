...
#Region "Create and Destroy"
	...
	Public Sub New()
		...
		AddHandler Me.DoWork, AddressOf Me.MappingTool_DoWork
	End Sub
...
#Region "Methods"
	...
	Public Sub Run(ByVal gameSetupSelectedIndex As Integer)
		Dim info As New MappingToolInfo()
...
#Region "Private Methods that can be called in either the main thread or the background thread"
	...
	Private Sub Halt(ByVal calledFromBackgroundThread As Boolean)
		If Me.theMappingToolProcess IsNot Nothing AndAlso Not Me.theMappingToolProcess.HasExited Then
			Try
				If Not Me.theMappingToolProcess.CloseMainWindow() Then
					Me.theMappingToolProcess.Kill()
				End If
			Catch ex As Exception
				Dim debug As Integer = 4242
			Finally
				Me.theMappingToolProcess.Close()
				Me.theMappingToolProcess = Nothing
...
#Region "Private Methods that are called in the background thread"
	...
	Private Sub MappingTool_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs)
		Me.ReportProgress(0, "")

		Dim info As MappingToolInfo

		info = CType(e.Argument, MappingToolInfo)
		Me.theGameSetupSelectedIndex = info.gameSetupSelectedIndex
		If MappingToolInputsAreOkay() Then
			Me.UpdateProgress(1, "Mapping tool opened.")
			Me.RunMappingTool()
		End If
	End Sub

	'TODO: Check inputs as done in Compiler.CompilerInputsAreValid().
	Private Function MappingToolInputsAreOkay() As Boolean
	...
	Private Sub RunMappingTool()
		...
		Me.theMappingToolProcess.EnableRaisingEvents = True
		Me.theMappingToolProcess.StartInfo = myProcessStartInfo

		Me.theMappingToolProcess.Start()
		Me.theMappingToolProcess.WaitForExit()
		Me.theMappingToolProcess.Close()
		Me.theMappingToolProcess = Nothing
...
#Region "Data"
	...
	Private theMappingToolProcess As Process
