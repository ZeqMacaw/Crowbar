Public Class SourceMdlFileData32
	...
	Public unused(11) As Integer

	Public theAnimationDescs As List(Of SourceMdlAnimationDesc32)
	...
	Public theBoneControllers As List(Of SourceMdlBoneController32)
	...
	Public theHitboxSets As List(Of SourceMdlHitboxSet32)
	...
	Public theSequenceDescs As List(Of SourceMdlSequenceDesc32)
	...
	Public theFirstAnimationDesc As SourceMdlAnimationDesc32
