Public Class SourceVtxFileData06
	...
	Public theVtxBodyParts As List(Of SourceVtxBodyPart06)
	Public theVtxMaterialReplacementLists As List(Of SourceVtxMaterialReplacementList06)
