...
#Region "Methods"
	...
	Public Sub ReadMdlHeader00(ByVal logDescription As String)
		...
		If logDescription <> "" Then
			Me.theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, logDescription + " (Actual version: " + Me.theMdlFileData.version.ToString() + "; override version: 35)")
		End If
	End Sub
