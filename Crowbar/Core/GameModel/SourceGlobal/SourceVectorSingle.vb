Public Class SourceVectorSingle
	...
	Public Function CrossProduct(ByVal otherVector As SourceVectorSingle) As SourceVectorSingle
		Dim crossVector As New SourceVectorSingle()
	...
	Public Function Normalize() As SourceVectorSingle
		Dim magnitude As Single
		Dim normalVector As New SourceVectorSingle()

		magnitude = CSng(Math.Sqrt(Me.x * Me.x + Me.y * Me.y + Me.z * Me.z))
