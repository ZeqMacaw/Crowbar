Public Class SourceMdlBone10Single
	...
	'	float				value[6];	// default DoF values
	'	float				scale[6];   // scale for delta DoF values
	Public position As SourceVectorSingle
	Public rotation As SourceVectorSingle
	Public positionScale As SourceVectorSingle
	Public rotationScale As SourceVectorSingle
