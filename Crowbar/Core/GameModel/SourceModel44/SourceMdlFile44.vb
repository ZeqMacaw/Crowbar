...
#Region "Methods"
	...
	Public Sub ReadMdlHeader00(ByVal logDescription As String)
		...
		If logDescription <> "" Then
			Me.theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, logDescription + " (Actual version: " + Me.theMdlFileData.version.ToString() + "; override version: 44)")
		End If
	End Sub
	...
	Private Sub ReadHitboxes(ByVal hitboxOffsetInputFileStreamPosition As Long, ByVal aHitboxSet As SourceMdlHitboxSet)
		If aHitboxSet.hitboxCount > 0 Then
			...
			For j As Integer = 0 To aHitboxSet.hitboxCount - 1
				...
				'NOTE: Ignore getting the hitbox name because it's not important for compiling, and unknown when to use nameOffset as absolute or relative offset.
				'      I looked at many models from various games that use MDL44 and none of them had anything for the name, 
				...
				If aHitbox.nameOffset <> 0 AndAlso (Me.theMdlFileData.version = 44 AndAlso Me.theMdlFileData.theVindictusTextSCAL = "SCAL") Then
	...
	Protected Sub ReadAnimationFrames(ByVal animInputFileStreamPosition As Long, ByVal anAnimationDesc As SourceMdlAnimationDesc44, ByVal sectionFrameCount As Integer, ByVal sectionIndex As Integer, ByVal lastSectionIsBeingRead As Boolean)
		If ((anAnimationDesc.flags And SourceMdlAnimationDesc.STUDIO_FRAMEANIM) <> 0) Then
			'TEST: Do any MDL v48 models use this flag?
	...
	Protected Sub ReadAnimationFrameByBone(ByVal animInputFileStreamPosition As Long, ByVal anAnimationDesc As SourceMdlAnimationDesc44, ByVal sectionFrameCount As Integer, ByVal sectionIndex As Integer, ByVal lastSectionIsBeingRead As Boolean)
	...
	Public Sub ReadFlexControllerUis()
		If Me.theMdlFileData.flexControllerUiCount > 0 AndAlso Not (Me.theMdlFileData.version = 44 AndAlso Me.theMdlFileData.flexControllerUiOffset = SourceMdlFileData44.text_SCAL_VERSION44Vindictus) Then
