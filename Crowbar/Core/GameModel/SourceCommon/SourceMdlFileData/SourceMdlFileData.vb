Public Class SourceMdlFileData
	...
	Public soundindex As Integer
	Public soundgroups As Integer
	Public soundgroupindex As Integer
	...
	' VERSION 44: 
	'	int					zeroframecacheindex;
	Public zeroframecacheindex_VERSION44_47 As Integer
	'------------
	' VERSION 48:
	'	int					unused4; // zero out if version < 47
	...
	' VERSION 48:
	'	int					numflexcontrollerui;
	Public flexControllerUiCount_VERSION48 As Integer
	'	int					flexcontrolleruiindex;
	...
	Public Const STUDIOHDR_FLAGS_AMBIENT_BOOST_MDL44 As Integer = 1 << 15
	...
	Public Const STUDIOHDR_FLAGS_SUBDIVISION_SURFACE As Integer = 1 << 19
