...
#Region "Methods"
	...
	Public Sub ReadMdlHeader00(ByVal logDescription As String)
		...
		If logDescription <> "" Then
			Me.theMdlFileData.theFileSeekLog.Add(fileOffsetStart, fileOffsetEnd, logDescription + " (Actual version: " + Me.theMdlFileData.version.ToString() + "; expected version: 46)")
		End If
	End Sub
